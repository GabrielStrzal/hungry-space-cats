...
public class GameSetting {
    ...
    public static final long ENERGY_MAKER_PLACE_TIME = 5; //seconds
    public static final long OXYGEN_MAKER_PLACE_TIME = 5; //seconds
    ...
    public static final int OXYGEN_MAKER_ADDED_OXYGEN = 30;

    public static final int ENERGY_MAKER_CASH_COST = 10;
    public static final int OXYGEN_MAKER_CASH_COST = 10;
